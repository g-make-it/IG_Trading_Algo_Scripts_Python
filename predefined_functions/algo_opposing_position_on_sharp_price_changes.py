...
class Algo0:
    ...
    def signal_generation(self, epic):
        ...
        if len(self.map_epic_data_minute[epic]) >=2:
            ...
            bid_old = object_epic_data["BID"]
            offer_old= object_epic_data["OFFER"]
            high_old = object_epic_data["HIGH"]
            low_old =object_epic_data["LOW"]

            del(self.map_epic_data_minute[epic][0])

            percentage_change = ((bid - bid_old)/bid)*100

            spread_percentage = ((offer - bid)/bid ) *100
